...
export function FeatureSolutionSection(solutionProps: ISolutionProps) {
  ...
  return (
    <>
      <section className="py-4 px-8 lg:px-20 mx-auto ">
                ...
                <div className="text-center justify-items-center mb-0">
                  <div className="justify-center justify-items-center mb-0 md:w-[930px] lg:w-max-[1200px]">
                    ...
                    <div className="relative w-full overflow-visible">
                      <img
                        className="relative z-0 h-auto w-full max-w-full rounded-t-2xl object-contain object-center md:h-[550px] border-4 border-blue-gray-800 shadow-lg hover:cursor-pointer"
                      ...
                      <div className="border-4 border-blue-gray-200 rounded-b-2xl">
                        <div className="absolute mt-2 left-1/2 z-50 flex -translate-x-1/2 gap-3 pointer-events-auto">
                          {gallery.map((_, i) => (
                            <button
                              key={i}
                              type="button"
                              ...
                              className={`inline-block h-3 rounded-full transition-all ring-1 ring-white/80 shadow-sm focus:outline-none focus:ring-2 focus:ring-white hover:border-2 hover:border-accent-500 ${
                                galleryActiveIndex === i ? "w-10 bg-blue-gray-800 shadow-md " : "w-4 bg-slate/30 "
                              }`}
                            />
                          ))}
                        </div>
                    ...
                    <div key={index}>
                      <img
                        ...
                        className={`h-20 max-w-full cursor-pointer rounded-lg object-cover object-center border-2 ${
                          gallery[galleryActiveIndex].src === src ? "border-blue-gray-800" : "border-white"
