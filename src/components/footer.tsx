      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-between gap-4 pt-4 md:flex-row ">
          <div>
            ...
            <Typography
              color="blue-gray"
              className="text-sm font-normal text-blue-gray-300"
            >
              Made with <a href="https://astro.build/" target="_blank" className="text-blue-gray-700 hover:underline">Astro</a>, React, Tailwind CSS, and
