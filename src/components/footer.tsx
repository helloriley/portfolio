    ...
    <footer className={"px-8 py-8 " + backgroundGradient}>
      <div className="container mx-auto">
        ...
        <div className="flex flex-col items-start justify-between gap-4 md:flex-row ">
          ...
          >
            Made with 
            <span className="h-5 w-5 inline-block align-top mx-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} className="size-5 fill-blue-gray-200 stroke-blue-gray">
