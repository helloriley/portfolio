      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-between gap-4 pt-4 md:flex-row ">
          <div>
            ...
            >
              Design Engineer specialising in UI/UX, design and development.
            </Typography>
            <Typography
              color="blue-gray"
              className="text-base font-medium text-blue-gray-300"
            >
              Made with <a href="https://astro.build/" target="_blank" className="text-blue-gray-700 hover:underline">Astro</a>, React, Tailwind CSS + 
              <span className="h-5 w-5 inline-block align-middle mx-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
