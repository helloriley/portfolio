...
export function HeroPresentation() {
  return (
    <header className="h-full w-screen place-items-center bg-white relative px-8 py-8 lg:mb-16">
      ...
      <div className="">
        <img src={baseURL + "/images/banner-home-6d-1200x1100.jpg"} alt="components" className="lg:absolute lg:-top-12 right-0 w-full lg:w-1/2 hover:scale-105 delay-150 duration-500 transition-transform object-cover" />
      </div>
    </header>
