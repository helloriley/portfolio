  ...
  return (
    <section id="about" className="py-8 px-8 lg:py-14 bg-gradient-to-b from-blue-gray-50/40 to-blue-gray-50/30">
      <div className="container mx-auto mb-20 text-center">
        ...
        >
            As a <span className="font-bold">Design Engineer</span> - hybrid UI/UX Designer &amp; Frontend Developer - I&apos;m passionate about crafting seamless user experiences that <span className="font-bold">bridge user goals and business objectives</span>.
